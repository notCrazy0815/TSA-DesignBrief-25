...
<section class="newsletter" bind:this={newsletterElement}>
    {#if isVisible}
        <div class="background-elements">
            <div class="leaf leaf-1" in:fly={{ x: -100, y: 50, duration: 1000, delay: 200 }}></div>
            <div class="leaf leaf-2" in:fly={{ x: 100, y: -50, duration: 1000, delay: 300 }}></div>
            <div class="leaf leaf-3" in:fly={{ x: -80, y: -30, duration: 1000, delay: 400 }}></div>
            <div class="circle circle-1" in:scale={{ start: 0, duration: 800, delay: 500, easing: elasticOut }}></div>
            <div class="circle circle-2" in:scale={{ start: 0, duration: 800, delay: 600, easing: elasticOut }}></div>
        </div>
        
        <div class="content" in:fly={{ y: 30, duration: 800, delay: 100 }}>
            <h2 in:scale={{ start: 0.8, duration: 600 }}>Stay Fresh with Verdantia</h2>
            <div class="divider" in:scale={{ start: 0, duration: 800 }}></div>
            <p in:fade={{ duration: 800, delay: 300 }}>
                Subscribe to our newsletter for seasonal menu updates, exclusive event invitations,
                and plant-based cooking tips straight from our kitchen to yours.
            </p>
            
            {#if !subscribed}
                <form on:submit|preventDefault={handleSubmit} class="signup-form" in:fade={{ duration: 800, delay: 450 }}>
                    <input 
                        type="email" 
                        bind:value={email} 
                ...
                <p class="privacy-note" in:fade={{ duration: 800, delay: 600 }}>
                    We respect your privacy and will never share your email. Unsubscribe anytime.
                </p>
            {:else}
                <div class="success-message" in:scale={{ start: 0.8, duration: 600, easing: quintOut }}>
        ...
        .background-elements {
            ...
            .leaf {
                ...
                &.leaf-2 {
                    ...
                    width: 100px;
                    height: 50px;
                    border-radius: 70% 30% 50% 40% / 50% 60% 30% 70%;
